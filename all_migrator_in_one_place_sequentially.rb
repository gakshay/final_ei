...
puts "Creating Dump of new Database Clearsenses_v2(wrong image path) as /tmp/clearsenses_v3.sql..."
system "mysqldump -uroot clearsenses_v2 > /tmp/clearsenses_v3.sql"

puts "Creating new DATABASE clearsenses_v3..."
system "mysql -u root --execute=\"DROP DATABASE IF EXISTS clearsenses_v3;\""
system "mysql -u root --execute=\"CREATE DATABASE clearsenses_v3 CHARACTER SET utf8 COLLATE utf8_unicode_ci;\""

puts "Importing the clearsenses_v2 to clearsenses_v3..."
system "mysql -u root clearsenses_v3 < /tmp/clearsenses_v2.sql"
